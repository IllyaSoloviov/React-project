...
import {useGameDetailsQuery} from "@/hooks/usePopularGamesQuery";
    ...
    return (
        <div className="flex-1 bg-bg-secondary flex justify-center items-center p-8">
            <div className="bg-bg-secondary rounded-xl shadow-lg overflow-hidden">
                ...
                <div className="p-6 md:p-8 grid text-text grid-cols-1 lg:grid-cols-3 gap-8">
                    <div className="lg:col-span-2">
                        <h2 className="text-2xl font-bold border-b-2 border-accent/20 pb-2 mb-4">Description</h2>
                    ...
                    <div className="lg:col-span-1 text-text">
                        <h2 className="text-2xl  font-bold border-b-2 border-accent/20 pb-2 mb-4">Details</h2>
                        <div className="space-y-4">
                            ...
                            <div className="flex justify-between items-center bg-background p-3 rounded-lg">
                                ...
                                <div className="text-right">
                                    ...
                                    <p className="text-xs text-text-secondary">{game.ratings_count} voted</p>
                                </div>
                            </div>
